...
export function MobileMemberCard({ member, onUpdate, onDelete, onAddPayment, onDeletePayment, getPayments }: MobileMemberCardProps) {
  ...
  return (
    <div className="relative">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden active:scale-[0.98] transition-all duration-200">
        {/* Header */}
        <div className="p-4">
      ...
      {/* Payment Form Modal - Moved OUTSIDE the transforming container */}
      {showPaymentForm && (
        <div 
        ...
        >
          <div 
            className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-auto relative shadow-2xl animate-in zoom-in-95 duration-200"
      ...
      {/* Payment History Modal - Moved OUTSIDE the transforming container */}
      {showHistory && (
        <div 
          className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[9999]"
          onClick={(e) => {
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 w-full max-w-md md:max-w-2xl max-h-[85vh] overflow-auto relative shadow-2xl animate-in zoom-in-95 duration-200">
            <PaymentHistory
              member={member}
